...
launcher = 'none'
load_from = '/home/ben/nycu_hw/2026version_HuBMAP_Hacking_the_Human_Vasculature/mmdet_v3_solution/work_dirs/stage2/epoch_7.pth'
log_level = 'INFO'
...
train_cfg = dict(max_epochs=13, type='EpochBasedTrainLoop', val_interval=2)
    ...
    dataset=dict(
        ...
        pipeline=[
            ...
            dict(
                policies=[
                    [
                        dict(level=6, prob=0.6, type='Color'),
                    ],
                    [
                        dict(prob=0.6, type='Equalize'),
                    ],
                    [
                        dict(level=4, prob=0.5, type='ShearX'),
                        dict(level=4, prob=0.5, type='ShearY'),
                    ],
                    [
                        dict(level=4, prob=0.5, type='TranslateX'),
                        dict(level=4, prob=0.5, type='TranslateY'),
                    ],
                    [
                        dict(level=6, prob=0.6, type='Rotate'),
                    ],
                    [
                        dict(level=4, prob=0.5, type='Brightness'),
                        dict(level=4, prob=0.5, type='Contrast'),
                    ],
                ],
                type='AutoAugment'),
            dict(
