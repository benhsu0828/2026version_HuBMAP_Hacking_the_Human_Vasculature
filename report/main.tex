...
\begin{itemize}
    \item \textbf{WSI-aware validation.} Dataset 1 is split by spatial \texttt{i} location instead of random tile splitting. The write-up reports that this split is harder than random splitting, which makes it more useful for avoiding over-optimistic validation.
